...
public class StoreOrders implements Customizable{
    ...
    /**
     * Converts orders database to a String ArrayList.
     * @return ArrayList<String>
     */
    public ArrayList<String> getStringDatabase(){
        ArrayList<String> db = new ArrayList<String>();
        for (Order o : ordersDatabase){
            db.add(o.print());
        }
        return db;
    }
    ...
    public ArrayList<Integer> getStoreOrdersNumbers(){
        ArrayList<Integer> storeOrdersNum = new ArrayList<Integer>();
        for (Order o : ordersDatabase){
            storeOrdersNum.add(o.getOrderNumber());
        }
        return storeOrdersNum;
    }
}
